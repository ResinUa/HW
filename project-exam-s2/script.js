...
s10btn1.addEventListener("click", () => {
  [s10hidden2, s10hidden3, s10hidden4].forEach(el => el.style.zIndex = "-1");
  [s10thing2, s10thing3, s10thing4].forEach(el => el.style.zIndex = "-1");
  [s10hidden2, s10hidden3, s10hidden4].forEach(el => el.style.position = "absolute");
  [s10thing2, s10thing3, s10thing4].forEach(el => el.style.position = "absolute");
  [s10hidden2, s10hidden3, s10hidden4].forEach(el => el.style.opacity = "0");
...
s10btn2.addEventListener("click", () => {
  [s10hidden1, s10hidden3, s10hidden4].forEach(el => el.style.zIndex = "-1");
  [s10thing1, s10thing3, s10thing4].forEach(el => el.style.zIndex = "-1");
  [s10hidden1, s10hidden3, s10hidden4].forEach(el => el.style.position = "absolute");
  [s10thing1, s10thing3, s10thing4].forEach(el => el.style.position = "absolute");
  [s10hidden1, s10hidden3, s10hidden4].forEach(el => el.style.opacity = "0");
...
s10btn3.addEventListener("click", () => {
  [s10hidden2, s10hidden1, s10hidden4].forEach(el => el.style.zIndex = "-1");
  [s10thing2, s10thing1, s10thing4].forEach(el => el.style.zIndex = "-1");
  [s10hidden2, s10hidden1, s10hidden4].forEach(el => el.style.position = "absolute");
  [s10thing2, s10thing1, s10thing4].forEach(el => el.style.position = "absolute");
  [s10hidden2, s10hidden1, s10hidden4].forEach(el => el.style.opacity = "0");
...
s10btn4.addEventListener("click", () => {
  [s10hidden2, s10hidden3, s10hidden1].forEach(el => el.style.zIndex = "-1");
  [s10thing2, s10thing3, s10thing1].forEach(el => el.style.zIndex = "-1");
  [s10hidden2, s10hidden3, s10hidden1].forEach(el => el.style.position = "absolute");
  [s10thing2, s10thing3, s10thing1].forEach(el => el.style.position = "absolute");
  [s10hidden2, s10hidden3, s10hidden1].forEach(el => el.style.opacity = "0");
